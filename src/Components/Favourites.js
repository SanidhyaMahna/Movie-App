...
export default class Favourites extends Component {
  ...
  render() {
    ...
    let si = (this.state.currPage - 1) * this.state.limit; // si => start index
    let ei = si + this.state.limit - 1;//ei+. end index
    filteredMovies = filteredMovies.slice(si, ei + 1); //last index is not included in slice
